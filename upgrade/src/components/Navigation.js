...
export default function Header2({ title }) {
  ...
  return (
    <header className="p-6">
      <div className="inset-x-0 mx-auto w-full max-w-screen-md border border-gray-100 bg-white/80 py-2 shadow backdrop-blur-lg md:top-6 rounded-3xl lg:max-w-screen-lg">
        <div className="px-4">
